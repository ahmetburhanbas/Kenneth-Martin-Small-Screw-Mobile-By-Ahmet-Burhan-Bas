...
struct ContentView: View {
    ...
    let yellowish = Color(red: 0.78, green: 0.65, blue: 0.35, opacity: 1)// Color yellow
    let brown = Color(red: 0.37, green: 0.23, blue: 0.13, opacity: 1)// Color brown
    let stick1 = Color(red: 0.40, green: 0.368, blue: 0.309, opacity: 1)
    let stick2 = Color(red: 0.65, green: 0.63, blue: 0.6, opacity: 1)   
    let background = Color(red: 0.87, green: 0.862, blue: 0.866, opacity: 1)  
    var body: some View {
        VStack {
            ZStack{
                background
