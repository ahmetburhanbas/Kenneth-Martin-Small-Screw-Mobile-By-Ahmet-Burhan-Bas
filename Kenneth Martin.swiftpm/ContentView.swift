...
struct ContentView: View {
    ...
    let sarımtırak = Color(red: 0.78, green: 0.65, blue: 0.35, opacity: 100)
    let kahvetırak = Color(red: 0.37, green: 0.23, blue: 0.13, opacity: 100)
    let cıbık = Color(red: 0.40, green: 0.368, blue: 0.309, opacity: 100)
    let cıbık2 = Color(red: 0.65, green: 0.63, blue: 0.6, opacity: 100)   
    var body: some View {
        VStack {
            ZStack{
                Color.white
                Button(action: {
                    ...
                    Text("Start")
                        ...
                        .background(LinearGradient(gradient: Gradient(colors: [cıbık, cıbık2]), startPoint: .leading, endPoint: .trailing))
                        .cornerRadius(10)
                        .overlay(
                            RoundedRectangle(cornerRadius: 10)
                                .stroke(sarımtırak, lineWidth: 2))
                ...
                if percentage == 1{
                    ZStack {
                        Ellipse()
                            ...
                            .foregroundColor(cıbık2)
                            .position(x: 202.4, y: 45)
                        Circle()
                        .stroke(cıbık, lineWidth: 3)
                        .frame(width: 12.36)
                ...
                .stroke(sarımtırak, style: StrokeStyle(lineWidth: 6, lineCap: .butt, lineJoin: .round))
                ...
                .trim(from: 0, to: percentage)
                .stroke(cıbık, style: StrokeStyle(lineWidth: 4, lineCap: .butt, lineJoin: .round))
                ...
                .trim(from: 0, to: percentage)
                .stroke(cıbık2, style: StrokeStyle(lineWidth: 4, lineCap: .butt, lineJoin: .round))
                .animation(.easeOut(duration: 10), value: percentage) 
                ...
                Path() { path in
                 ...
                 .trim(from: 0, to: percentage)
                 .stroke(kahvetırak, style: StrokeStyle(lineWidth: 6, lineCap: .butt, lineJoin: .round))
                 .animation(.easeOut(duration: 10.0), value: percentage)
            }          
